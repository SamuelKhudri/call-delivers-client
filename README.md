...
This project was bootstrapped with [Create React App] live link : (https://simple-firebase-authenti-b4a63.web.app/).
...
## Mainly point
we use: Firebase install, Firebase init, Firebase Deploy, Heroku setup and add the server, and  Mongodb database server npm run build
